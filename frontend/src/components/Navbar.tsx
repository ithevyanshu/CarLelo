...
const Navbar = () => {
  return (
    <>
      <nav className="fixed w-full flex justify-between shadow-lg bg-slate-200 text-gray-700 p-3 sm:px-16">
        <div className="text-3xl font-extrabold text-black">CarLelo</div>
